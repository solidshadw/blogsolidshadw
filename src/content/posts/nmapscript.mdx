...
description: "A Python script to automate nmap scanning - performs quick port discovery followed by comprehensive scans with service detection and vulnerability scripts"
createdAt: 2023-02-01
image: "../assets/nmapscript.png"
tags:
  - coding
  - python
  - copilot
